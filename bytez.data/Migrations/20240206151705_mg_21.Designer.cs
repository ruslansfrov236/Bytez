...
namespace bytez.data.Migrations
{
    ...
    [Migration("20240206151705_mg_21")]
    partial class mg_21
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("bytez.entity.Entities.Email", b =>
                {
                    b.HasOne("bytez.entity.Entities.ContactWall", "ContactWall")
                        .WithMany("Emails")
                        .HasForeignKey("ContactWallId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ContactWall");
                });
